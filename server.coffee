...
exports.client_newHunt = exports.newHunt = newHunt = (amount = 1, cb = false) !->
	...
	hunts = [
		...
		"Puking"
		"With a Ferrari"
		"With adidas slippers"
		"With a string on your head"
		"In a club"
		"With a sexdoll"
		"With a model"
		"Giving a hobo some change"
		"Wearing a keepers suit"
		"With a old person (70+)"
		"With a electric plug in your nose"
		"In cafe de klomp"
		"Holding a frog"
		"With a hedgehog"
		"With a broken egg on your head"
		"Eating snickers"
		"Eating wasabi"
		"Wearing 1 yellow sock and 1 pink sock"
		"With a police officer"
		"With a nurse"
		"In the trunk of a pickup truck"
		"With a golden teeth"
		"In a basket"
		"Planking on a speed control post"
		"Dancing on a bar"
		"Wearing lingerie"
		"With a garden gnome"
		"With 222,22 euros"
		"On chat roulette with the opponent wearing a shoe on his head"
		"With the coach of the opposite team"
		"With Peter van Gestel"
		"With a gay person"
		"Doing atje pion"
		"Driving 170 km/h (I am not responsible)"
		"Bleeding"
		"With a apple pie"
		"With a mailman"
		"With a ginger"
		...
		"With a gorilla"
		"Giving a high five to a team mates dad"
		"Scoring a goal"
		"Backstage"
		"Buying condoms in the kruitvat"
		"At the top of a Dixie"
		"In a plane"
		"Playing monopoly"
		"Playing stef stuntpiloot"
		"Playing beer pong"
		"On a hospital bed"
		"With a train driver"
		"Burning a newspaper"
		"With fireworks"
		"Sunburned"
		"With Marit van Eeden"
		"With the champions blouse of 2012-2013"
